...
jQuery.extend(jQuery.mobile.datebox.prototype.options.lang, {
	'de': {
		...
		titleDateDialogLabel: "Datum w&auml;hlen",
		titleTimeDialogLabel: "Zeit w&auml;hlen",
		daysOfWeek: ["Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"],
		daysOfWeekShort: ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"],
		monthsOfYear: ["Januar", "Februar", "M&auml;rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"],
		...
		tooltip: "&Ouml;ffne Datumsauswahl",
